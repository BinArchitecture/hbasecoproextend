...
./kafka_2.11-0.8.2.1/bin/kafka-topics.sh --zookeeper hanode3:2181,hanode4:2181,hanode5:2181,hanode6:2181,hanode7:2181 --create --topic idxHBaseKafkaEsRegionServerSync --partitions 64 --replication-factor 1
