...
public interface AggHandlerIntegerface {
public AggResult agg(String tableName,String qulifier,String classType,AggEnum type,
		 final Scan scan,AggregationClient aggregationClient,Set<String> scanRange);
}
