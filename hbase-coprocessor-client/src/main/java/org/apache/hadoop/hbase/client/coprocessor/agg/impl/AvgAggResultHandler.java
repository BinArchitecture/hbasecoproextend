...
public class AvgAggResultHandler implements AggResultHandlerInterface{
	
	private static AggResultHandlerInterface instance=new AvgAggResultHandler();
