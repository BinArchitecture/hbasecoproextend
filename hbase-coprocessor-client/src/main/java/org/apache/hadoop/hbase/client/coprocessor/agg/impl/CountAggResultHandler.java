...
public class CountAggResultHandler implements AggResultHandlerInterface{
	
	private static AggResultHandlerInterface instance=new CountAggResultHandler();
	...
	public void aggResult(List<ScanAggRunable> lls, AggResult result , String classType) throws IllegalStateException {
		...
		for (ScanAggRunable srn : lls) {
			...
			rowNum += agg.getRowCountResult();
		}
		result.setRowCountResult(rowNum);
	}
