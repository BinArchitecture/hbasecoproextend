...
public class SumAggHandler implements AggHandlerIntegerface{
	private static SumAggHandler instance=new SumAggHandler();
	private SumAggHandler(){
	}
	public static SumAggHandler getInstance(){
		return instance;
	}
	@Override
	public AggResult agg(String tableName, String qulifier, String classType,
		...
		try {
			BigDecimal stgResult = aggregationClient.sum(TableName.valueOf(tableName), qulifier, scan, scanRange);
