...
public interface AggGroupByHandlerIntegerface {
public AggGroupResult groupBy(String tableName,String qulifier,String classType,AggGroupByEnum type,
		List<String> groupby, final Scan scan,AggregationGroupByClient aggregationGroupByClient,Set<String> scanRange);
}
