...
public interface AggGroupByResultHandlerInterface {
	public void aggResult(List<GroupByScanRunable> lls,AggGroupResult result , String classType) throws IllegalStateException;
}
