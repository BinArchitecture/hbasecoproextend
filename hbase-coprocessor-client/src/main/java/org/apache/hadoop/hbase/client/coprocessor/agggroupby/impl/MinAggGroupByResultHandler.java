...
public class MinAggGroupByResultHandler implements AggGroupByResultHandlerInterface{
	
	private static AggGroupByResultHandlerInterface instance=new MinAggGroupByResultHandler();
	...
	public void aggResult(List<GroupByScanRunable> lls, AggGroupResult aggResult,
		...
		if(classType.equals(String.class.getSimpleName())){
			...
			Map<String,String> stgResult=HbaseUtil.calcMin(lla,String.class);
			...
			Map<String,Double> stgResult=HbaseUtil.calcMin(lla,Double.class);
			...
			Map<String,Date> stgResult=HbaseUtil.calcMin(lla,Date.class);
