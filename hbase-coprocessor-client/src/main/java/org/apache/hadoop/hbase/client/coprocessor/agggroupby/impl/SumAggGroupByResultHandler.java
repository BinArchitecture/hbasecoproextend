...
public class SumAggGroupByResultHandler implements AggGroupByResultHandlerInterface {

	private static AggGroupByResultHandlerInterface instance = new SumAggGroupByResultHandler();
	...
	public void aggResult(List<GroupByScanRunable> lls, AggGroupResult aggResult,
		...
		Map<String,Double> stgResult=HbaseUtil.calcSum(lla);
