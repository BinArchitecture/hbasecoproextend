...
public class IdxHbaseSyncMetaZKConsumer extends BaseHbaseKafkaConsumer<IdxKafkaMsg>
{
	public void setKafkaListener(
			KafkaConsumerListener<IdxKafkaMsg> kafkaListener) {
		super.setKafkaListener(kafkaListener);
	}

	@Override
	protected void initClazz() {
		super.setClazz(IdxKafkaMsg.class);
	}

	public void doInit(Configuration cf){
		super.setGroupId(Constants.KAFKASYNCZK_GROUP);
		super.doInit(cf);
	}

	@Override
	protected void initTopic() {
		super.setTopic(Constants.KAFKASYNCZK_TOPIC);
	}   
