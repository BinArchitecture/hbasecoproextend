...
public class JedisHbaseFlushConsumer extends BaseHbaseKafkaConsumer<String>{

	@Override
	protected void initClazz() {
		super.setClazz(String.class);
	...
	public void doInit(Configuration cf){
		super.setGroupId(Constants.HBASEJEDISGROUP);
		super.doInit(cf);
	}

	@Override
	public void setKafkaListener(KafkaConsumerListener<String> kafkaListener) {
